...
import HomeAiContent from "./home-ai-content/HomeAiContent";

const HomeMain = () => {
  const [activetab, setActivTab] = useState<number>(1);

  return (
    <div className='home-main'>
      {/* home up - title */}
      <HomeTitle />
      {/* home bottom - ai content */}
      <div className='home-main-bottom'>
        <div className='home-main-bottom-form'>
          <div className='home-main-bottom-form-tabs'>
            {/* link tab */}
            <div
              className={
                activetab === 3 ? "hb-form-tab active-link" : "hb-form-tab"
              }
              onClick={() => setActivTab(3)}>
              <span
                className={
                  activetab === 3
                    ? "hb-form-tab-text active-hb-form-text"
                    : "hb-form-tab-text"
                }>
                لینک
              </span>
            ...
            <div
              className={
                activetab === 2 ? "hb-form-tab active-archive" : "hb-form-tab"
              }
            ...
            <div
              className={
                activetab === 1 ? "hb-form-tab active-record" : "hb-form-tab"
              }
          ...
          {/* ai content - fetch datas here */}
          <HomeAiContent activetab={activetab} />
        </div>
      </div>
    </div>
  );
