...
import SimpleText from "@/components/ai-output/simple-text/SimpleText";
import TimeText from "@/components/ai-output/time-text/TimeText";
import AiOutputPlayer from "@/components/ai-output/ai-ouput-player/AiOutputPlayer";
    ...
    <div className="ai-bottom">
      <div className="ab-top">
        ...
        <div
          className={
            activeText === 1
              ? "ab-top-simple-text  active-text"
              : "ab-top-simple-text"
          }
      ...
      {/* file voice output */}
      <div className="ab-output-bottom">
        <AiOutputPlayer
          setPaused={setPaused}
          paused={paused}
